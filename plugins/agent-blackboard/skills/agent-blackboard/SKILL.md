...
```bash
npx -y agent-blackboard@0.1.2 sessions create root-123 --agent claude-code --version 1.0.13
npx -y agent-blackboard@0.1.2 sessions create worker-456 --parent-session-id root-123 \
  --agent claude-code --version 1.0.13
npx -y agent-blackboard@0.1.2 sessions patch worker-456 --data '{"branch":"fix/retry"}'
npx -y agent-blackboard@0.1.2 append --session-id worker-456 '{"note":"found the failing edge case"}'
npx -y agent-blackboard@0.1.2 get --session-id worker-456 --format markdown
```
