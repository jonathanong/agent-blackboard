...
```bash
npx -y agent-blackboard@0.2.0 sessions create root-123 --agent claude-code --version 1.0.13
npx -y agent-blackboard@0.2.0 sessions create worker-456 --parent-session-id root-123 \
