...
import type { HeaderMap, JournalEntry, QueryMap } from './types.mjs'
...
/**
 * Resolves the output format for `GET /journals`: `?format=` wins if present
...
export function formatEntries(
  format: EntryFormat,
  entries: AsyncIterable<JournalEntry>,
