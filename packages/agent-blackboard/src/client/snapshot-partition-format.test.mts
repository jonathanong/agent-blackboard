...
it('strictly validates snapshot record and terminal manifest shapes', () => {
  ...
  for (const change of [
    ...
    { selection: { archived: false, dataArrayContains: [] } },
    { selection: { archived: false, dataArrayContains: { repositories: 1 } } },
    { selection: { archived: false, dataArrayContains: { repositories: '' } } },
    { selection: { archived: false, dataArrayContains: {} } },
    { selection: { archived: false, dataArrayContains: { '': 'owner/repo' } } },
